...
describe('Pokemon', () => {
  ...
  test('render a card', () => {
    const { getByTestId } = renderWithRouter(<Pokemon pokemon={pokemons[0]} isFavorite={false} />);
  ...
  test('should render the correct image', () => {
    const { getByAltText } = renderWithRouter(<Pokemon pokemon={pokemons[0]} isFavorite={false} />);
  ...
  test('should render an Link', () => {
    const { getByText } = renderWithRouter(<Pokemon pokemon={pokemons[0]} isFavorite={false} />);
